...
def sms(type_of_movement, location, person_in_danger=None):
    ...
    # Verifying the type of movement detected
    ...
    # In case blood is detected, make a call with a critical message
